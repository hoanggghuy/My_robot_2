...
def generate_launch_description():
    ...
    params_file_dec = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(get_package_share_directory('my_bot'),'config','ball_tracker_params_example.yaml'),
